...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Delete__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_axios__);



var deleteElement = document.querySelectorAll('.deleteElement');
if (deleteElement) {
    deleteElement.forEach(function (el) {
        el.addEventListener('click', function (e) {
            e.preventDefault();
            Object(__WEBPACK_IMPORTED_MODULE_0__Delete__["a" /* Delete */])({
...
var FileCountries = document.getElementById('FileCountries');
if (FileCountries) {
    var FileCategories = document.getElementById('FileCategories');
    FileCountries.addEventListener('change', function () {
        var country = this[this.selectedIndex].value;
        FileCategories.options.length = 0;
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/admin/country/' + country + '/categories/').then(function (r) {
...
var DeleteClass = function () {
    function DeleteClass(settings) {
        _classCallCheck(this, DeleteClass);

        this.settings = settings;
        this.init();
    }

    _createClass(DeleteClass, [{
        key: "init",
        value: function init() {
            var _this = this;
